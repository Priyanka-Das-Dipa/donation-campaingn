...
import DonationCards from "../../../pages/Donation/DonationCards";
...
const Banner = () => {
  ...
  return (
    <div>
      ...
      <div
      className="h-[80vh] flex justify-center items-center mb-10 relative"
      style={{ backgroundImage: "url(/Resources/bannerpicture.png)" }}
    >
      ...
      >
        <div className="relative flex justify-center items-center h-10 w-full min-w-[200px] max-w-[24rem]">
          <input
            type="text"
